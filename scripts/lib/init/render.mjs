...
function listOrNotSpecified(values) {
  return Array.isArray(values) && values.length > 0 ? values.join('; ') : NOT_SPECIFIED;
}
...
function renderers(manifest, template) {
  return {
    ...
    'paper/references.bib': `@comment{Add bibliographic entries for ${manifest.projectName}.}\n`
  };
}
